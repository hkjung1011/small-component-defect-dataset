...
DEFAULT_OUTPUT = ROOT / "synthetic" / "v1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate deterministic KIA7809AF synthetic defect data with masks and labels.")
...
def main() -> int:
    ...
    for primary_class in primary_classes:
        ...
        for ordinal in range(per_class):
            ...
            sample_id = f"syn-v1-{primary_class}-{ordinal:04d}"
    ...
    release = {
        ...
        "generator_version": config["generator_version"],
        "generator_script": "scripts/generate_synthetic.py",
